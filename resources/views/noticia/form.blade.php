<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <!-- <div class="form-group">
            {{ Form::label('foto_inicio') }}
            {{ Form::text('foto_inicio', $noticia->foto_inicio, ['class' => 'form-control' . ($errors->has('foto_inicio') ? ' is-invalid' : ''), 'placeholder' => 'Foto Inicio']) }}
            {!! $errors->first('foto_inicio', '<div class="invalid-feedback">:message</div>') !!}
        </div> -->
        <div class="form-group">
